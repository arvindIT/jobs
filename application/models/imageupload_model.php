...
class imageupload_model extends CI_Model
{
    ...
    */
    ...
    function uploadBigImage($uploadFile,$bigImgPath,$smallImgPath,$thumb,$existImage,$fullImages)
    {
...
//		print_r($data);
    ...
    function uploadSQL($uploadFile,$bigImgPath,$smallImgPath,$thumb,$existImage,$fullImages)
    {
        $upload_name = $uploadFile;
		$config['upload_path'] = $bigImgPath; /* NB! create this dir! */  
