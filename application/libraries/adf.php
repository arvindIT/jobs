...
class adf {
	...
	private $userId = 18430189;
	private $publicKey = 'c07994950b6bf3eae42b3e35d4e3ce62';
	private $secretKey = '1f5cbd32-1b09-47b2-890e-8d900260356a';
	private $connection = null;

	public function __construct() {
		$this->connection = Http::connect(self::BASE_HOST, 443, Http::HTTPS);
		$this->secretKey = '1f5cbd32-1b09-47b2-890e-8d900260356a';
		$this->publicKey = 'c07994950b6bf3eae42b3e35d4e3ce62';
		$this->userId = 18430189;
	}
