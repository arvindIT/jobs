...
$head_title = $this->lang->line('label_qualification_management');
?>
<!-- page content -->
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <a class="btn btn-xs btn-success" href="<?php echo $this->config->item('admin_base_url')?>qualification_management/add_record" title="<?= $this->lang->line('common_label_qualification_management_new')?>"><i class="fa fa-plus-circle"></i>&nbsp;<?php echo $this->lang->line('common_label_qualification_management_new')?></a>
...
<script>
    function contact_search(allflag)
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>admin/qualification_management/" + uri_segment,
            data: {
