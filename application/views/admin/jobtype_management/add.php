    ...
    <div class="">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><?php echo $this->lang->line('common_label_jobtype_form'); ?></h2>
                    ...
                    <div class="x_content">
                        ...
                        <form id="qualification-form" method="post" action="" data-parsley-validate class="form parsley-form form-horizontal form-label-left" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"><?php echo $this->lang->line('common_label_jobtype_name')?><span class="required">*</span>
                                </label>
        ...
        if ($('#qualification-form').parsley().isValid())
        {
            ...
            $.ajax({
                ...
                success: function (data) {
                    window.location.href = "<?php echo $this->config->item('admin_base_url') . 'jobtype_management'; ?>";
                }
            });
            return false;
        }
