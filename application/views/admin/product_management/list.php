            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <a class="btn btn-xs btn-success" href="<?= $this->config->item('admin_base_url')?>product_management/add_record" title="<?= $this->lang->line('common_label_product_management_new')?>"><i class="fa fa-plus-circle"></i>&nbsp;<?= $this->lang->line('common_label_product_management_new')?></a>
