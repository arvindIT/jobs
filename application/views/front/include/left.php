...
if($this->uri->segment(2)!= 'cinemas_chain_management')
{
  $this->session->unset_userdata('cinemas_chain_sortsearchpage_data');
}
?>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li>
						<a href="<?=base_url('admin/user_management/')?>"><i class="fa fa-home"></i><?= $this->lang->line('common_label_users_management');?></a>
                    </li>
                    <li <?php if($this->uri->segment(2)=='register'){?> class="active" <?php } ?>>
						<a href="<?=base_url('admin/register')?>"><i class="fa fa-edit"></i> <?= $this->lang->line('common_label_users_register_form');?></a>
					</li>
                    <li <?php if($this->uri->segment(2)=='register'){?> class="active" <?php } ?>>
						<a href="<?=base_url('admin/user_contacts')?>"><i class="fa fa-address-book" aria-hidden="true"></i><?= $this->lang->line('common_label_users_contacts');?></a>
					</li>
                    <li <?php if($this->uri->segment(2)=='qualification_management'){?> class="active" <?php } ?>>
						<a href="<?=base_url('admin/qualification_management')?>"><i class="fa fa-graduation-cap" aria-hidden="true"></i><?= $this->lang->line('common_label_qualification');?></a>
					</li>
					<li <?php if($this->uri->segment(2)=='jobtype_management'){?> class="active" <?php } ?>>
						<a href="<?=base_url('admin/jobtype_management')?>"><i class="fa fa-clipboard" aria-hidden="true"></i><?= $this->lang->line('label_job_type_management');?></a>
					</li>
					<li <?php if($this->uri->segment(2)=='jobs_management'){?> class="active" <?php } ?>>
						<a href="<?=base_url('admin/jobs_management')?>"><i class="fa fa-clipboard" aria-hidden="true"></i><?= $this->lang->line('label_jobs_management');?></a>
					</li>
